...
class FirstCountDownTimerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_first_count_down_timer)
    ...
    private fun countDownTimer(st:Long): CountDownTimer {
        ...
        return object : CountDownTimer(st, 100) {
            ...
            override fun onFinish() {
                ...
                mp = MediaPlayer.create(this@FirstCountDownTimerActivity, R.raw.timeup)
                mp.isLooping = true
                mp.start()
